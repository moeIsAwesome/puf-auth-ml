...
train_folder_paths = ["./dataset/data/RPi2Dump", "./dataset/data/RPi3Dump"]
train_labels = [1, 2]
...
test_folder_path = "./dataset/data/RPi1Dump"

# Read data from test folder (RPi1Dump)
...
plot_confidence_distribution(
    test_confidences, "Confidence Distribution for Unlabeled Test Data (RPi1Dump)")
