...
# Paths to folders
folder_paths = ["./dataset/data/RPi1Dump", "./dataset/data/RPi3Dump"]
labels = [0, 1]
...
model_filename = 'svm_model_trained_on_one_and_three_compressed.pkl'
...
def plot_confusion_matrix(y_true, y_pred, dataset_type):
    ...
    sns.heatmap(cm, annot=True, fmt='d', cmap='Blues', xticklabels=[
                'RPi1', 'RPi3'], yticklabels=['RPi1', 'RPi3'])
