...
train_folder_paths = ["./dataset/data/RPi1Dump", "./dataset/data/RPi3Dump"]
train_labels = [0, 2]
...
test_folder_path = "./dataset/data/RPi2Dump"

# Read data from test folder (RPi2Dump)
...
plot_confidence_distribution(
    test_confidences, "Confidence Distribution for Unlabeled Test Data (RPi2Dump)")
