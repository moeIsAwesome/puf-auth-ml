...
model_filename = './reports/trained_with_intact_length_512/svm_model_trained_with_all_intact_for_test_on_all_percentages_except_30p.pkl'
...
# Example usage
new_puf_file = './dataset/random/rnd_512/rnd7.bin'
